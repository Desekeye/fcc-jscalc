    ...
    <>
      <div className="container">
        ...
        <div id="calculator">
          ...
          <button id="divide" onClick={()=>buttonPress("/")}className="light-green">/</button>
          ...
          <button id="multiply" onClick={()=>buttonPress("*")}className="light-green">*</button>
          ...
          <button id="subtract" onClick={()=>buttonPress("-")}className="light-green">-</button>
          ...
          <button id="add" onClick={()=>buttonPress("+")}className="light-green">+</button>
          ...
          <button id="equals" onClick={()=>buttonPress("=")}className="light-green">=</button>
        </div>
      </div>
    </>
  )
